...
public class CameraCaptureTest extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button processButton2 = (Button) findViewById(R.id.process);
		Button processButton3 = (Button) findViewById(R.id.process);
		...
		processButton2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Bitmap captureBmp = null;
				...
				for (int y = 0; y < height; y++) {
					for (int x = 0; x < width; x++) {
						int value = captureBmp.getPixel(x, y);
						if (value < 0xff808080)
							tmpBmp.setPixel(x, y, 0xff080808);
						else
							tmpBmp.setPixel(x, y, 0xffffffff);
					}
				}
		...
		processButton3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Bitmap captureBmp = null;
