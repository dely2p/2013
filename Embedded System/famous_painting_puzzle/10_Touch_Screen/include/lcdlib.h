...
//#define MODE_TFT_1BIT_320240   (0x4501)
//#define MODE_TFT_8BIT_320240 	 (0x4502)
#define MODE_TFT_16BIT_480272    (0x4504)
...
// LTP400WQ LCD
#define VBPD_480272			((33-1)&0xff)
#define VFPD_480272			((11-1)&0xff)
#define VSPW_480272			((2-1) &0x3f)
#define HBPD_480272			((88-1)&0x7f)
#define HFPD_480272			((40-1)&0xff)
#define HSPW_480272			((128-1)&0xff)
...
//#define VFPD_320240		((3-1)&0xff)
//#define VSPW_320240		((4-1) &0x3f)
//#define HBPD_320240		((2-1)&0x7f)
//#define HFPD_320240		((3-1)&0xff)
...
//Timing parameter for LTS350Q1-PE1(SAMSUNG) (TK)-start
#define VBPD_320240_PE1		((1-1)&0xff)    //2
#define VFPD_320240_PE1		((7-1)&0xff)    //4 
#define VSPW_320240_PE1		((1-1) &0x3f)   //1 
#define HBPD_320240_PE1		((1-1)&0x7f)    //7 
#define HFPD_320240_PE1		((14-1)&0xff)    //3 
#define HSPW_320240_PE1		((1-1)&0xff)    //4     (TK)-end
//#define VBPD_320240_PE1		((1-1)&0xff)    //2
//#define VFPD_320240_PE1		((14-1)&0xff)    //4 
//#define VSPW_320240_PE1		((1-1) &0x3f)   //1 
//#define HBPD_320240_PE1		((1-1)&0x7f)    //7 
//#define HFPD_320240_PE1		((7-1)&0xff)    //3 
//#define HSPW_320240_PE1		((1-1)&0xff)    //4     (TK)-end
...
//TFT 480272
extern U32 (*frameBuffer8BitTft480272)[SCR_XSIZE_TFT_480272/4];
extern U32 (*frameBuffer16BitTft480272)[SCR_XSIZE_TFT_480272/2];
//TFT 640480
...
void Lcd_Lpc3600Disable(void); //(TK) -add
