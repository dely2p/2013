...
;=================
// by iloy 2004.08.23
BIT_EINT0     EQU  (0x00000001)
BIT_EINT1     EQU  (0x00000002)
BIT_EINT2     EQU  (0x00000004)
BIT_EINT3     EQU  (0x00000008)
BIT_EINT4_7   EQU  (0x00000010)
BIT_EINT8_23  EQU  (0x00000020)
BIT_NOTUSED6  EQU  (0x00000040)
BIT_BAT_FLT   EQU  (0x00000080)
BIT_TICK      EQU  (0x00000100)
BIT_WDT       EQU  (0x00000200)
BIT_TIMER0    EQU  (0x00000400)
BIT_TIMER1    EQU  (0x00000800)
BIT_TIMER2    EQU  (0x00001000)
BIT_TIMER3    EQU  (0x00002000)
BIT_TIMER4    EQU  (0x00004000)
BIT_UART2     EQU  (0x00008000)
BIT_LCD       EQU  (0x00010000)
BIT_DMA0      EQU  (0x00020000)
BIT_DMA1      EQU  (0x00040000)
BIT_DMA2      EQU  (0x00080000)
BIT_DMA3      EQU  (0x00100000)
BIT_SDI       EQU  (0x00200000)
BIT_SPI0      EQU  (0x00400000)
BIT_UART1     EQU  (0x00800000)
BIT_NOTUSED24 EQU  (0x01000000)
BIT_USBD      EQU  (0x02000000)
BIT_USBH      EQU  (0x04000000)
BIT_IIC       EQU  (0x08000000)
BIT_UART0     EQU  (0x10000000)
BIT_SPI1      EQU  (0x20000000)
BIT_RTC       EQU  (0x40000000)
BIT_ADC       EQU  (0x80000000)
