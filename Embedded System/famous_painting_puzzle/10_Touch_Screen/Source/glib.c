...
void _PutTft16Bit_480272(U32 x,U32 y,U32 c)
{
    if(x<480 && y<272)
       frameBuffer16BitTft480272[(y)][(x)/2]=( frameBuffer16BitTft480272[(y)][x/2]
...
{	
	...
	for(j=0;j<SCR_YSIZE_TFT_640480;j++)
            for(i=0;i<SCR_XSIZE_TFT_640480;i++)
		        PutPixel(i,j,c);
    //else if((type==MODE_TFT_1BIT_320240)|(type==MODE_TFT_8BIT_320240)|(type==MODE_TFT_16BIT_320240))
