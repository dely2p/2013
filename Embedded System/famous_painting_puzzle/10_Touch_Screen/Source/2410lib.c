...
void Uart_Init_k(int pclk,int baud)
{
    int i;
...
//====================================================================
int Uart_GetString(char *string, int leng)	// leng 추가
{
    char *string2 = string;
    char c;
    while(leng && ((c = Uart_Getch())!='\r'))	// leng 추가
    {
        if(c=='\b')
        {
...
int Uart_GetIntNum(void)
{
    ...
    while(Uart_GetString(string, 30)) {}			// 수정
    ...
    else
    {
        ...
        {
            if(('A' <= string[i]) && (string[i] <= 'Z'))	// 대문자	// 수정, isalpha() 오동작
            		result = (result<<4) + string[i] - 'A' + 10;
            else if(('a' <= string[i]) && (string[i] <= 'z'))		// 소문자
            		result = (result<<4) + string[i] - 'a' + 10;
            /*if(isalpha(string[i])
            {
                if(isupper(string[i]))
...
//========================*[ MPLL ]==============================*
void ChangeMPllValue_k(int mdiv,int pdiv,int sdiv)
{
...
//========================[ HCLK, PCLK ]===========================
void ChangeClockDivider_k(int hdivn,int pdivn)
{
...
//========================**[ UPLL ]==============================*
void ChangeUPllValue_k(int mdiv,int pdiv,int sdiv)
{
