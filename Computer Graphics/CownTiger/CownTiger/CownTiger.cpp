...
//	glColor3f(0.0,0.0,0.0);
    ...
    glutAddMenuEntry("±×³É ¼Ò", 1);	
    glutAddMenuEntry("»¡°£ ¼Ò", 2);
	glutAddMenuEntry("³ë¶û ¼Ò", 3);
    glutAddMenuEntry("ÃÊ·Ï ¼Ò", 4);

	GLint subTigerColorID = glutCreateMenu(t_color);	
    glutAddMenuEntry("±×³É È£¶ûÀÌ", 1);	
    glutAddMenuEntry("»¡°£ È£¶ûÀÌ", 2);
	glutAddMenuEntry("³ë¶û È£¶ûÀÌ", 3);
    glutAddMenuEntry("ÃÊ·Ï È£¶ûÀÌ", 4);

	glutCreateMenu(main_menu);
	glutAddSubMenu("¼ÒÀÇ »ö±ò", 1);
	glutAddSubMenu("È£¶ûÀÌÀÇ »ö±ò", 2);
